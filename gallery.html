		...
		<div class="container">
			...
			<nav id="menu">
				...
				<ul>
					...
					<li><a href="index.html" class="get-contact">Contact</a></li>
   				</ul>
			</nav>
			<!-- / navigation -->
		</div>
		...
		<div class="container">
						...
						<li>
							<div class="slide">
								<ul>
									...
									<li><a href="#"><img src="images/23.png" alt=""></a></li>
									...
									<li><a href="#"><img src="images/30.png" alt=""></a></li>
			...
			<aside id="sidebar">
				<div class="widget sidemenu">
					<ul>
					<h2><li class="current">Swipe to see More</li></h2>
					</ul>
				</div>
			</aside>
			<!-- / sidebar -->
